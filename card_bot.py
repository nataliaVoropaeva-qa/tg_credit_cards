...
bot = TeleBot(token='5619198797:AAG_AtruwPRqf2OrkcNFigoh8xqfyybQOF4', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет! Ты даже не представляешь, как я рад тебя видеть! Я умею генерировать номер тестовой банковской карты\nВыбери тип карты:', # текст сообщения
